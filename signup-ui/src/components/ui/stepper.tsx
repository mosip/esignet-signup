          ...
          style={
            {
              ...
              "--step-width": variables?.["--step-width"] || "1px",
...
const verticalStepVariants = cva(
  [
    ...
    "data-[completed=true]:[&:not(:last-child)]:after:w-[var(--step-width)]",
