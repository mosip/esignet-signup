    ...
    private String generateOTPChallenge(String challengeTransactionId) {
        ...
        try {
            RestResponseWrapper<OtpResponse> restResponseWrapper = selfTokenRestTemplate
                    ...
                    .getBody();
            System.out.println(restResponseWrapper);
            ...
            log.error("Generate Challenge Endpoint {} is unreachable.", generateChallengeUrl);
            throw new SignUpException(ErrorConstants.OTP_SERVER_DOWN);
        }
