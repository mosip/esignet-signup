	...
	public void test(TestCaseDTO testCaseDTO) throws AuthenticationTestException, AdminTestException, SecurityXSSException {
		...
		if (inputJson.contains("$PHONENUMBERFROMREGEXFORSIGNUP$")) {
			...
			if (phoneNumber != null && !phoneNumber.isEmpty()) {
				inputJson = replaceKeywordWithValue(inputJson, "$PHONENUMBERFROMREGEXFORSIGNUP$", phoneNumber, testCaseName);
...
//			String password = getPasswordPattern();
			...
			if (password != null && !password.isEmpty()) {
				inputJson = replaceKeywordWithValue(inputJson, "$PASSWORDTOREGISTERUSER$", password, testCaseName);
//				writeAutoGeneratedId(testCaseDTO.getTestCaseName(), "PASSWORD", password);
		...
		if (inputJson.contains("$PASSWORDTORESET$")) {
			...
			if (passwordToReset != null && !passwordToReset.isEmpty()) {
				inputJson = replaceKeywordWithValue(inputJson, "$PASSWORDTORESET$", passwordToReset, testCaseName);
			}
		}
