package io.mosip.testrig.apirig.signup.testrunner;
	...
	public static void startTestRunner() {
		...
		if (files != null) {
			...
			for (File file : files) {
				...
				if (file.getName().toLowerCase().contains(GlobalConstants.SIGNUP)) {
					if (file.getName().toLowerCase().contains("prerequisite")) {
						BaseTestCase.setReportName(GlobalConstants.SIGNUP + "-prerequisite");
					} else {
